...
def remove_smallest(numbers):
    if numbers:
        ...
        # Returning a new list excluding the smallest number at the found index
        return numbers[:smallest_index] + numbers[smallest_index + 1:]
    else:
        # Returning an empty list if the input list was empty
        return []
    
    
# NB: Solution two fails original list mutation test
# Solution two/Alternate solution
